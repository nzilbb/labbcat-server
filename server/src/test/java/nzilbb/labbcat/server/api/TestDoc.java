...
/**
 * Test the <tt>api/doc/</tt> endpoint.
...
public class TestDoc {
  ...
  /** Ensure main document can be retrieved. */
  @Test public void doc() throws Exception {
    String info = l.getInfo();
    // could be null, or have a document, as long as an exception isn't thrown either is ok
  }

  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.labbcat.server.api.TestDoc");
  }
}
