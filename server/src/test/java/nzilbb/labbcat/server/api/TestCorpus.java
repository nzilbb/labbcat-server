...
/**
 * Test the <tt>api/corpus</tt> endpoint.
...
public class TestCorpus {
  ...
  @Test public void corpus() throws Exception {
    ...
    Map<String,String> stats = l.getCorpusInfo(ids[0]);
    assertTrue("Some stats are returned", stats.size() > 0);
    // System.out.println(""+stats);

    try {
      l.getCorpusInfo("invalid-id");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.labbcat.server.api.TestCorpus");
  }
}
