...
/**
 * Test the <tt>api/dashboard/statistics</tt> endpoint.
...
public class TestStatistics
{
  ...
  /** Test statistics dashboard items are returned */
  @Test public void dashboardStatistics() throws Exception {
    DashboardItem[] items = l.getDashboardItems("statistics");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.labbcat.server.api.dashboard.TestStatistics");
  }
}
