...
/**
 * Test the <tt>api/dashboard/express</tt> endpoint.
...
public class TestExpress {
  ...
  /** Test express dashboard items are returned */
  @Test public void dashboardExpress() throws Exception {
    DashboardItem[] items = l.getDashboardItems("express");
  ...
  public static void main(String args[]) {
    org.junit.runner.JUnitCore.main("nzilbb.labbcat.server.api.dashboard.TestExpress");
  }
}
