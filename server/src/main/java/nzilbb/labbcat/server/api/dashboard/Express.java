...
/**
 * <tt>/api/dashboard/express</tt>
 * : Access to dashboard items.
 *  <p> Lists items for the 'express' page dashboard, with the following attributes:
 *   <ul>
 ...
 *   on the 'statistics' page, which are individually configurable.
 ...
 */
public class Express extends Dashboard {   
  public Express() {
    whereClause = "express = 1";
  }
} // end of class Express
