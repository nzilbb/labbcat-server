...
//
/**
 * <p> <tt>/api/serialize/&hellip;</tt>
 * : API endpoints related to serialization of annotation graphs/fragments.
 *
 * <p> (These class implementations are decoupled from any HTTP request/response object model.
 * HTTP transaction details are currently implemented by JSP files in <tt>src/main/jsp/serialize/</tt>)
 */
