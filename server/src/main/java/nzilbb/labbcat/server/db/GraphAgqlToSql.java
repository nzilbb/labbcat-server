...
public class GraphAgqlToSql {
  ...
  public Query sqlFor(String expression, String sqlSelectClause, String userWhereClause, String orderClause, String sqlLimitClause)
    ...
    AGQLBaseListener listener = new AGQLBaseListener() {
        ...
        @Override public void enterAscendingOrderExpression(
          AGQLParser.AscendingOrderExpressionContext ctx) {
          if (conditions.size() > 0) conditions.push(", ");
        }
        @Override public void exitAscendingOrderExpression(
          AGQLParser.AscendingOrderExpressionContext ctx) {
          // no need for: conditions.push(" ASC");
        }
        @Override public void enterDescendingOrderExpression(
          AGQLParser.DescendingOrderExpressionContext ctx) {
          if (conditions.size() > 0) conditions.push(", ");
        }
        @Override public void exitDescendingOrderExpression(
          AGQLParser.DescendingOrderExpressionContext ctx) {
